    ...
    <div className="home_page bg-black py-8 px-6 rounded-2xl">
      <div className="mb-20">
        <div className="flex justify-between flex-wrap gap-5 items-center mb-5 sm:mb-8">
          ...
          <p>ACCOUNT IS AUTOMATICALLY RENEWED UNLESS YOU SWITCH OFF THE RECURRING BILLING ON THE SETTINGS / ACCOUNT PAGE BEFORE THE RENEWAL DATE.<br>
          </br>
          The membership renewal fees will be the rates available at the time of renewal. If you renew your membership, the time will start on the same day you renew. SDC does not take responsibility for renewal fees if member fails to switch off their recurring billing. All sales are final and no refund are offered.
          </p>
        </div>
